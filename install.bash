...
packets_to_install=(apt-transport-https python3 python3-pip neovim htop fail2ban sqlite3 zip unzip ufw net-tools jq make cmake at screen bc cron psmisc)
